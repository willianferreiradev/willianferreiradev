...
## 💻 Sobre Mim
Sou desenvolvedor web e mobile, apaixonado por criar experiências digitais que realmente impactem o usuário. Tenho experiência em frontend e backend, além de explorar sempre novas tecnologias para entregar soluções modernas e eficientes.

Além disso, adoro estudar **desenvolvimento de jogos**, mecânicas de física em 2D, e transformar ideias em projetos práticos.
